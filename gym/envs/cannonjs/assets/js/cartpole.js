...
(function(){
    ...
    var pendX = 0.5;
    var pendY = 0.5;
    var pendZ = cartY * (125 / 30); // Ratio from CartPoleV0, cartpole.py
    ...
    function initCannon() {
        ...
        addBodiesAndConstraints();
    }

    function addBodiesAndConstraints() {
        /////////
        // Bodys
        ...
        // Pendulum
        var pendulumShape = new CANNON.Box(
            new CANNON.Vec3(pendX / 2.0, pendY / 2.0, pendZ / 2.0)
        );
        var pendulumBody = new CANNON.Body({
            mass: 1,
